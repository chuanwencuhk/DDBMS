...
void init_schema()
{
    ...
    sch.table[1].table_name = "sal";
    sch.table[2].table_name = "emp";
    sch.table[3].table_name = "job";
    sch.table[4].table_name = "asg";
    //table1="sal" no fragment
    sch.table[1].site_num = 1;
    sch.table[1].type = -1;
	sch.table[1].site[1].condition[0] = "null";
	sch.table[1].col_num = 2;
    sch.table[1].col_name[1] = "title";
    sch.table[1].col_name[2] = "sal";
    //table2="emp", 4 fragment, just Horizantal fragment
	sch.table[2].site_num = 4;	sch.table[2].type = 0;
    sch.table[2].site[1].condition[0] = "eno<'E1000'&title<'N'";
    sch.table[2].site[2].condition[0] = "eno<'E1000'&title>='N'";
    sch.table[2].site[3].condition[0] = "eno>='E1000'&title<'N'";
    sch.table[2].site[4].condition[0] = "eno>='E1000'&title>='N'";
	//分片条件
    sch.table[2].site[1].hcon_list_len = 2;
    sch.table[2].site[2].hcon_list_len = 2;
    sch.table[2].site[3].hcon_list_len = 2;
    sch.table[2].site[4].hcon_list_len = 2;
    sch.table[2].site[1].hcon_list[1].attr = "eno";
    sch.table[2].site[1].hcon_list[1].op = "<";
    sch.table[2].site[1].hcon_list[1].section = "'E1000'";
    sch.table[2].site[1].hcon_list[2].attr = "title";
    sch.table[2].site[1].hcon_list[2].op = "<";
    sch.table[2].site[1].hcon_list[2].section = "'N'";
    sch.table[2].site[2].hcon_list[1].attr = "eno";
    sch.table[2].site[2].hcon_list[1].op = "<";
    sch.table[2].site[2].hcon_list[1].section = "'E1000'";
    sch.table[2].site[2].hcon_list[2].attr = "title";
    sch.table[2].site[2].hcon_list[2].op = ">=";
    sch.table[2].site[2].hcon_list[2].section = "'N'";
    sch.table[2].site[3].hcon_list[1].attr = "eno";
    sch.table[2].site[3].hcon_list[1].op = ">=";
    sch.table[2].site[3].hcon_list[1].section = "'E1000'";
    sch.table[2].site[3].hcon_list[2].attr = "title";
    sch.table[2].site[3].hcon_list[2].op = "<";
    sch.table[2].site[3].hcon_list[2].section = "'N'";
    sch.table[2].site[4].hcon_list[1].attr = "eno";
    sch.table[2].site[4].hcon_list[1].op = ">=";
    sch.table[2].site[4].hcon_list[1].section = "'E1000'";
    sch.table[2].site[4].hcon_list[2].attr = "title";
    sch.table[2].site[4].hcon_list[2].op = ">=";
    sch.table[2].site[4].hcon_list[2].section = "'N'";
	//表的列信息
	sch.table[2].col_num = 3;
    sch.table[2].col_name[1] = "eno";
    sch.table[2].col_name[2] = "ename";
    sch.table[2].col_name[3] = "title";
    //table3="job" 4 fragment,Horizontal+Vertial
    sch.table[3].site_num = 4;
    sch.table[3].type = 2;
    sch.table[3].site[1].condition[0] = "jno<'J0500'";
    sch.table[3].site[1].condition[1] = "jno,jname,budget";
    sch.table[3].site[2].condition[0] = "jno<'J0500'";
    sch.table[3].site[2].condition[1] = "jno,loc";
    sch.table[3].site[3].condition[0] = "jno>='J0500'";
    sch.table[3].site[3].condition[1] = "jno,jname,budget";
    sch.table[3].site[4].condition[0] = "jno>='J0500'";
    sch.table[3].site[4].condition[1] = "jno,loc";
	//分片条件
    sch.table[3].site[1].hcon_list_len = 1;
    sch.table[3].site[2].hcon_list_len = 1;
    sch.table[3].site[3].hcon_list_len = 1;
    sch.table[3].site[4].hcon_list_len = 1;
    sch.table[3].site[1].hcon_list[1].attr = "jno";
    sch.table[3].site[1].hcon_list[1].op = "<";
    sch.table[3].site[1].hcon_list[1].section = "'J0500'";
    sch.table[3].site[2].hcon_list[1].attr = "jno";
    sch.table[3].site[2].hcon_list[1].op = "<";
    sch.table[3].site[2].hcon_list[1].section = "'J0500'";
    sch.table[3].site[3].hcon_list[1].attr = "jno";
    sch.table[3].site[3].hcon_list[1].op = ">=";
    sch.table[3].site[3].hcon_list[1].section = "'J0500'";
    sch.table[3].site[4].hcon_list[1].attr = "jno";
    sch.table[3].site[4].hcon_list[1].op = ">=";
    sch.table[3].site[4].hcon_list[1].section = "'J0500'";
	//表的列信息
	sch.table[3].col_num = 4;
    sch.table[3].col_name[1] = "jno";
    sch.table[3].col_name[2] = "jname";
    sch.table[3].col_name[3] = "budget";
    sch.table[3].col_name[4] = "loc";

    sch.table[4].site_num = 4;
    sch.table[4].type = 0;
    sch.table[4].site[1].condition[0] = "eno<'E1000'&jno<'J0500'";
    sch.table[4].site[2].condition[0] = "eno<'E1000'&jno>='J0500'";
    sch.table[4].site[3].condition[0] = "eno>='E1000'&jno<'J0500'";
    sch.table[4].site[4].condition[0] = "eno>='E1000'&jno>='J0500'";
	//分片条件
    sch.table[4].site[1].hcon_list_len = 2;
    sch.table[4].site[2].hcon_list_len = 2;
    sch.table[4].site[3].hcon_list_len = 2;
    sch.table[4].site[4].hcon_list_len = 2;
    sch.table[4].site[1].hcon_list[1].attr = "eno";
    sch.table[4].site[1].hcon_list[1].op = "<";
    sch.table[4].site[1].hcon_list[1].section = "'E1000'";
    sch.table[4].site[1].hcon_list[2].attr = "jno";
    sch.table[4].site[1].hcon_list[2].op = "<";
    sch.table[4].site[1].hcon_list[2].section = "'J0500'";
    sch.table[4].site[2].hcon_list[1].attr = "eno";
    sch.table[4].site[2].hcon_list[1].op = "<";
    sch.table[4].site[2].hcon_list[1].section = "'E1000'";
    sch.table[4].site[2].hcon_list[2].attr = "jno";
    sch.table[4].site[2].hcon_list[2].op = ">=";
    sch.table[4].site[2].hcon_list[2].section = "'J0500'";
    sch.table[4].site[3].hcon_list[1].attr = "eno";
    sch.table[4].site[3].hcon_list[1].op = ">=";
    sch.table[4].site[3].hcon_list[1].section = "'E1000'";
    sch.table[4].site[3].hcon_list[2].attr = "jno";
    sch.table[4].site[3].hcon_list[2].op = "<";
    sch.table[4].site[3].hcon_list[2].section = "'J0500'";
    sch.table[4].site[4].hcon_list[1].attr = "eno";
    sch.table[4].site[4].hcon_list[1].op = ">=";
    sch.table[4].site[4].hcon_list[1].section = "'E1000'";
    sch.table[4].site[4].hcon_list[2].attr = "jno";
    sch.table[4].site[4].hcon_list[2].op = ">=";
    sch.table[4].site[4].hcon_list[2].section = "'J0500'";
	//表的列信息
	sch.table[4].col_num = 4;
    sch.table[4].col_name[1] = "eno";
    sch.table[4].col_name[2] = "jno";
    sch.table[4].col_name[3] = "resp";
    sch.table[4].col_name[4] = "dur";
...
void push_select_down(query_tree &tree)
{
    ...
    {	cout << "push_select_down():not to push select down\n"<<endl;
	}
	else
	{	//则要使用投影下推
