...
// extern bool RPCExecute(string host_ip, string dbname, string sql_statement);

// extern string RPCExecuteQuery(string host_ip, string dbname, string sql_statement);

// extern int RPCExecuteUpdate(string host_ip, string dbname, string sql_statement);

// extern bool RPCInsertFileToTable(string host_ip, string dbname, string sql_file, string table_name);
